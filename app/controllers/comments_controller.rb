class CommentsController < ApplicationController
	...
	def paginate 
	    ...
	    render "shared/paginate.js.erb", locals: {target: @comments.role, items: CommentsHelper.pagi( @comments, page: params[:page] ).deef, parameters: parameters }
	end
	...
	private
		...
		def comment_params
			params.require(:comment).permit(:root_id, :root_type, :commentable_id, :commentable_type, :role, :user_id, :comment)
		end
end
